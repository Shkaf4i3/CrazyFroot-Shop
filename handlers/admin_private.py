...
from handlers.classes_functions import IsAdmin, Add_sc, Add_eg
...
@admin_private_router.message(Add_sc.login)
...
@admin_private_router.message(Add_sc.password)
